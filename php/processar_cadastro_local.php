...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['cadastrar'])) {
    try {
        ...
        if (empty($_POST['nome']) || empty($_POST['endereco']) ||
            empty($_POST['descricao']) || empty($_POST['preco']) || empty($_POST['tipo_local'])) {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO locais (id_usuario, nome, endereco, descricao, preco, tipo_local) 
            VALUES (:id_usuario, :nome, :endereco, :descricao, :preco, :tipo_local)
        ");
