...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"> 
        ...
        <div class="bg-white shadow-md rounded-lg p-6"> 
            <?php if ($local['imagem_principal']): ?> 
                <img src="<?php echo htmlspecialchars($local['imagem_principal']); ?>"
                     alt="<?php echo htmlspecialchars($local['nome']); ?>" class="w-full h-60 object-cover rounded-md mb-4">
            <?php endif; ?> 
            <h2 class="text-xl font-semibold mb-2"><?php echo htmlspecialchars($local['nome']); ?></h2>
            <p class="text-gray-700 mb-4"><?php echo htmlspecialchars($local['descricao']); ?></p>
            <div class="flex justify-between">
                <a href="editar_local.php?id=<?php echo $local['id']; ?>" class="text-blue-500 hover:underline">Editar</a>
